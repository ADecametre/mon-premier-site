...
function cUpd(){
   ...
   //document.getElementById("cont").innerHTML += '<tr>';
       ...
       //if(x%5!=1){
           document.getElementById("cont").innerHTML = '<div class="s n'+(x%10)+'"><h1>'+x+'</h1><img class="img-responsive i'+(x%4)+'" src="https://risibank.fr/cache/stickers/d980/98001-full.png" width="153,375" height="300"></div>&nbsp;&nbsp;&nbsp;' + document.getElementById("cont").innerHTML;
       /*}else{
