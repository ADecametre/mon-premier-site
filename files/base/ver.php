...
<style>
    ...
    div.col-3.vers{
        height:100%;border-right:0.75px solid grey;border-top-right-radius:15px;border-bottom-right-radius:15px;padding-left:5px;
    }
    h6.vw.vers{
...
$(document).ready(function(){
    ...
    ');*/
    $GLOBALS["slideO"]=NULL;
    sql("SELECT `date`, `hour` FROM `ver` ORDER BY `v` ASC", null, '
                    ...
                    <li class="lev1">
                        ...
                        <div id="s'.$GLOBALS['vc'][$x].'" class="'.$GLOBALS['vt'][ $GLOBALS['vc'][$x] ].'_vers">
                            <ul class="lev2">
                                ...
                                echo " - ";
                                    sql("SELECT `date`, `hour` FROM `ver` WHERE `v`='".$GLOBALS['v2'][$x].".0'", null, '
                                        ...
                                        echo str_replace($num, $name, $row["date"]);if($row["hour"]!="00:00"){echo " <small>";ol_echo($row["hour"]);echo "</small>";}
                                        //echo $row["date"];
                                    ');
                            ...
                            $GLOBALS["da"]=true;for($GLOBALS["y"]=$GLOBALS["svn"][ $GLOBALS['vc'][$x] ];$GLOBALS["y"]>0;$GLOBALS["y"]--){
                                ...
                                //    S   V       T   I   M   E
                                    ...
                                    sql("SELECT `date`, `hour`, `desc`, `sdesc` FROM `ver` WHERE `v`='".$GLOBALS["vv"][$x].".".$GLOBALS["y"]."'", null, '
                                        
                                        echo \'<div align="center" class="row \';
                                        
                                        if(strpos($row["date"], "?")===false){
                                            
                                            switch(date_create_from_format("d/m/y H:i", date("d/m/y H:i"))<=>date_create_from_format("d/m/y H:i", $row["date"]." ".$row["hour"])){
                                                case "1":
                                        ...
                                        ol_echo(\'_vers">
                                            ...
                                            <div class="col-3 vers">
                                                <h6 class="vw"><i><u><small><small><small>
                                                    \'.$row["date"].\' <small>\');if($row["hour"]!="00:00"){ol_echo($row["hour"]);};ol_echo(\'</small>
                                                </small></small></small></u></i></h6>
                                            </div>
                                            <div class="col-7 vers">
                                                <h6 class="vw"><small><small><small>
                                                    \'.str_replace("\'", "\\\\\'", $row["desc"]));
                                                if($row["sdesc"]!=""){echo \'&nbsp;&nbsp;<a data-toggle="tooltip" data-placement="right" data-html="true" title="<small><small><small><p><p><p>\'.str_replace("\'", "\\\\\'", ol_echo($row["sdesc"], true)).\'</p></p></p></small></small></small>"><i style="opacity:0.66" class="fas fa-info-circle"></i></a>\';}
...
ol_echo('   
            ...
            <div class="modal-footer">
                <h5 style="font-size:2vw;" align="right">
                    <a href="#" data-dismiss="modal" data-toggle="modal" data-target="#b_acc"><i class="fas fa-lock" title="Accéder"></i></a>
                </h5>
            </div>
        <!--</div>-->
    </div>
