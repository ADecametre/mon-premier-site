        ...
        setTimeout(function(){
            ...
            switch(type){
                case "bot":
    			    ...
    			    $("div#nav").animate({width: '97.5%', left: '1.25%', right: '1.25%', top: '0px'/*, position: 'fixed'*/}, 150);
                ...
                case "top":
    			    ...
    			    $("div#nav").animate({width: '75%', left: '12.5%', right: '12.5%', top: 'auto'/*, position: 'relative'*/}, 150);
